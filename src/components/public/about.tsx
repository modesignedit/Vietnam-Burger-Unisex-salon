    ...
    <section id="about" className="py-24 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            {features.map((f, i) => (
              <div key={i} className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-gold font-semibold tracking-widest text-sm uppercase mb-1">{f.title}</h4>
        ...
        <div className="relative">
          <img src="https://picsum.photos/seed/urban-grooming/800/1000" alt="Elite grooming at Vietnam Burger" className="w-full h-auto object-cover" />
